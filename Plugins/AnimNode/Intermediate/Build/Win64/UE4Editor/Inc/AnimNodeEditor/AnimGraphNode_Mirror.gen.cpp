...
#include "AnimNodeEditor/Public/AnimGraphNode_Mirror.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAnimGraphNode_Mirror_Statics::NewProp_Node = { "Node", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimGraphNode_Mirror, Node), Z_Construct_UScriptStruct_FAnimNode_Mirror, METADATA_PARAMS(Z_Construct_UClass_UAnimGraphNode_Mirror_Statics::NewProp_Node_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimGraphNode_Mirror_Statics::NewProp_Node_MetaData)) };
	...
	IMPLEMENT_CLASS(UAnimGraphNode_Mirror, 580181542);
	template<> ANIMNODEEDITOR_API UClass* StaticClass<UAnimGraphNode_Mirror>()
	{
		return UAnimGraphNode_Mirror::StaticClass();
	}
